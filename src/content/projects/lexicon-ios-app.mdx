---
year: 2025
title: 'Lexicon: Interactive Vocabulary Learning App'
htmlTitle: 'Lexicon: Interactive Vocabulary Learning App'
description: 'An iOS app that transforms vocabulary learning through interactive chat-based exercises and AI-powered feedback.'
heroImage: '/src/assets/lexicon-chat.png'
...
links:
  ...
  - name: 'App Store'
    icon: 'Apple'
    url: 'https://apps.apple.com/us/app/lexicon-vocabulary'
  - name: 'Demo Video' 
    icon: 'Video'
    url: 'https://youtu.be/lexicon-demo'
---

# Lexicon: An Interactive Vocabulary Learning App
