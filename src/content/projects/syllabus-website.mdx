...
year: '2024'
heroImage: '../assets/syllabus-website.png'
heroImageAlign: 'center'
githubPath: 'syllabus-website'
links: [
  {
    label: 'Visit Website',
    href: 'https://syllabus.website'
  },
  {
    label: 'Featured Article',
    href: 'https://www.sbstatesman.com/2024/09/11/stony-brook-student-creates-new-tool-to-view-class-syllabi/'
  }
]
---
